    ...
    <div id="main_body">
    	<header class="s_header">
    		<nav>
    			...
    			<span style="font-size: 1.4rem"><?php echo ZController::$site_name;?>绑定账户</span>
    			<span id="more">&nbsp;&nbsp;&nbsp;&nbsp;</span>
    		</nav>
    	</header>
...
//     ZCommonFun::print_r_debug($model);
    ...
    <section class="survey-form ">
        ...
        <div class="form-group">
            <div class="btn_bg">
                <button type="submit" class="submit0" >绑定新账户</button>
            </div>
  
            <div class="btn_bg btn_bg2">
                <button type="submit" class="submit1">绑定已有的账户</button>
            </div>
        </div>
        <div class="form-group">
            <?php 
...
<script>
var is_submit = false;
var submit_class_name = '';
$(".submit0,.submit1").click(function(){
	var class_name = $(this).attr('class');
	submit_class_name = class_name;
	if(class_name=='submit1'){
