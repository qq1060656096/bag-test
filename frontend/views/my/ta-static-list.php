...
<div class="module module-comment" id="boxId_1447072536042_3">
	<div class="info-bar txt-l" style="display:none;">
		<div class="layout-box line-bottom" style="display:none;">
			<div class="box-col" >
...
alert(1);
    ...
    $(".load_more2").click(function(){
        var now =$(this);
        commentPage++;
        alert('<?php echo $ta_me;?>00');
        var url = "<?php echo Yii::$app->urlManager->createUrl(['comment/list','id'=>'','page'=>'#page#','sort'=>'sort','ta_me'=>$ta_me]);?>";
