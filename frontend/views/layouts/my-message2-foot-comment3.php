...
<?php
echo $this->renderFile(__DIR__ . '/../comment/my-message2-static-comment-message2.php',['uid'=>$uid,'ta_user_showNickname'=>'']);
?>
...
$(document).ready(function(){
    ...
    $(".card-list ").on('click','.line-bottom',function(){
        ...
        var url = "<?php echo Yii::$app->urlManager->createUrl(['my/ta-me-message','uid'=>'#uid#']);?>";
        url = url.replace('%23uid%23',$(this).attr('uid'));
